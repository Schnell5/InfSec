...
def viewer(imgdir, kind=Toplevel, cols=None):
    ...
    quitbtn = Button(win, text='Quit', command=win.quit, bg='beige')
...
if __name__ == '__main__':
    defdir = r'C:\Users\1\Google Диск\PYTHON\PP4E-Examples-1.4\Examples\PP4E\Gui\PIL\images'
    imgdir = (len(sys.argv) > 1 and sys.argv[1]) or defdir
